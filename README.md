...
**闭卷 <10% → 装上技能 ~90%+** · 上下文省 90% · 越界弃答 100% · 支持 6 种智能体
...
<div align="center"><img src="benchmark/docs/img/hard_psyc_correct_zh.svg" width="600" alt="闭卷与装上技能的正确率对比" /></div>
...
两个领域（人文事实召回 / 算法推导）结论一致：**不给材料模型答不出，靠材料才是正确率的来源**。技能与"裸文件智能体"精度接近但更省——它只取压缩过的相关章节，不是每题翻检整堆原始文件。
...
完整方法、三臂设计、成本、人工一致性校准、局限 → **[测试报告](benchmark/REPORT.md)**。
